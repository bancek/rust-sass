/* @ts-self-types="./rust_sass_wasm.d.ts" */
...
export function compileString(source, options) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compileString(ptr0, len0, options);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function compile_bytes(source, options) {
    const ptr0 = passArray8ToWasm0(source, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile_bytes(ptr0, len0, options);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {number} millis
 */
export function set_time_now(millis) {
    wasm.set_time_now(millis);
}
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_hasInstance_e133b1f9d9583238: function() {
        ...
        __wbg_new_025aca6e04fbafc8: function() {
            const ret = new Error();
            return ret;
        },
        ...
        __wbg_stack_e0374f93f53d759c: function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rust_sass_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
