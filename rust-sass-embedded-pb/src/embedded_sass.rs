...
pub mod inbound_message {
    ...
    pub mod compile_request {
        ...
        pub struct Importer {
            ...
            pub non_canonical_scheme: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
        ...
        pub mod importer {
            ...
            pub enum Importer {
                ...
                #[prost(message, tag = "5")]
                NodePackageImporter(super::super::super::NodePackageImporter),
            }
        }
        /// The input stylesheet to parse. Mandatory.
        #[derive(Clone, PartialEq, Eq, Hash, ::prost::Oneof)]
...
pub struct Value {
    ...
    #[prost(oneof = "value::Value", tags = "1, 2, 5, 6, 7, 8, 9, 10, 12, 13, 14")]
